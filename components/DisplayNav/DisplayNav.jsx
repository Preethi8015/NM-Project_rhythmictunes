    ...
    return (
        <>
            ...
            <div className='flex items-center gap-2 mt-4'>
                <button><p className='bg-white text-black px-4 py-1 rounded-2xl'>All</p> </button>
                <button><p className='bg-black px-4 py-1 rounded-2xl'>Music</p></button>
               <button><p className='bg-black px-4 py-1 rounded-2xl'>Podcasts</p></button>
            </div>
        </>
    )
}
